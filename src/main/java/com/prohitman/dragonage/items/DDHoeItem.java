...
public class DDHoeItem extends ToolItem {
    ...
    public DDHoeItem(IItemTier itemTier, float attackDamage, float attackSpeed, Item.Properties properties) {
        super(attackDamage, attackSpeed, itemTier, EFFECTIVE_ON_BLOCKS, properties.addToolType(net.minecraftforge.common.ToolType.HOE, itemTier.getHarvestLevel()));
    }
