...
public class ModItems 
{
	...
	public static final RegistryObject<Item> FIRE_BOMB = ITEMS.register("fire_bomb", () -> new LootBagItem(new Item.Properties().group(ModItemGroups.DRAGONS_DUNGEONS).maxStackSize(1)));
